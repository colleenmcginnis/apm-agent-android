...
See the [documentation](https://www.elastic.co/docs/reference/apm/agents/android) to find out more about its features, how to setup, and configuration details.
...
by following the [Getting started](https://www.elastic.co/docs/reference/apm/agents/android/getting-started)" guide and using the version defined [here](gradle.properties).